...
#ECL
#bash ./scripts/Informer/ECL/Informer_J/lambda_not_study/Informer_J_lambda0.sh
#bash ./scripts/Informer/ECL/Informer_J/lambda_not_study/Informer_J_lambda05.sh
#bash ./scripts/Informer/ECL/Informer_J/lambda_not_study/Informer_J_lambda1.sh
#bash ./scripts/Informer/ECL/Informer_J/lambda_not_study/Informer_J_lambda_not_stu_bigger_mr.sh
#ETTm1
bash ./scripts/Informer/ETTm1/Informer_J/lambda_not_stu/Informer_J_lambda0.sh
bash ./scripts/Informer/ETTm1/Informer_J/lambda_not_stu/Informer_J_lambda05.sh
bash ./scripts/Informer/ETTm1/Informer_J/lambda_not_stu/Informer_J_lambda1.sh
...
#ECL
#bash ./scripts/PatchTST/ECL/Informer_J/lambda_not_study/PatchTST_J_lambda0.sh
#bash ./scripts/PatchTST/ECL/Informer_J/lambda_not_study/PatchTST_J_lambda05.sh
#bash ./scripts/PatchTST/ECL/Informer_J/lambda_not_study/PatchTST_J_lambda1.sh
#bash ./scripts/PatchTST/ECL/Informer_J/lambda_not_study/PatchTST_J_lambda_not_stu_bigger_mr.sh
#ETTm1
bash ./scripts/PatchTST/ETTm1/PatchTST_J/lambda_not_stu/PatchTST_J_lambda0.sh
bash ./scripts/PatchTST/ETTm1/PatchTST_J/lambda_not_stu/PatchTST_J_lambda05.sh
bash ./scripts/PatchTST/ETTm1/PatchTST_J/lambda_not_stu/PatchTST_J_lambda1.sh
...
#ECL
#bash ./scripts/Crossformer/ECL/Crossformer_J/lambda_not_stu/Crossformer_J_lambda0.sh
#bash ./scripts/Crossformer/ECL/Crossformer_J/lambda_not_stu/Crossformer_J_lambda05.sh
#bash ./scripts/Crossformer/ECL/Crossformer_J/lambda_not_stu/Crossformer_J_lambda1.sh
#bash ./scripts/Crossformer/ECL/Crossformer_J/lambda_not_stu/Crossformer_J_lambda_bigger_mr.sh
#ETTm1
bash ./scripts/Crossformer/ETTm1/Crossformer_J/lambda_not_stu/Crossformer_J_lambda0.sh
bash ./scripts/Crossformer/ETTm1/Crossformer_J/lambda_not_stu/Crossformer_J_lambda05.sh
bash ./scripts/Crossformer/ETTm1/Crossformer_J/lambda_not_stu/Crossformer_J_lambda1.sh
