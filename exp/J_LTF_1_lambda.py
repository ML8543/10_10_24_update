...
# 联合训练
class Exp_Long_Term_Forecast_Imp_J_1_lambda(Exp_Basic):
    def __init__(self, args):
        super(Exp_Long_Term_Forecast_Imp_J_1_lambda, self).__init__(args)
        self.args = args
    ...
    def _select_optimizer(self):
        model_optim = optim.Adam([{'params':self.model.parameters()},
                                  {'params':self.imp_model.parameters(), 'lr': self.args.imp_lr}],lr=self.args.learning_rate)
        return model_optim
