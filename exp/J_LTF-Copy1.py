    ...
    def test(self, setting, test=0):
        ...
        with torch.no_grad():
            ...
            for i, (batch_x_raw, batch_y_raw, batch_x_mark, batch_y_mark) in enumerate(test_loader):
                ...
                ##################这两行是相比长期预测多加的，前两句和后两句只是batch_y/batch_x和batch_y_raw/batch_x_raw的区别
                ...
                ######下面四行中的二四两行的batch_y_raw都是由batch_y变过来的
